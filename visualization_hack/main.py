...
from visualization_hack.visualization import visualize_counts_plot

if __name__ == '__main__':
    data = read_counts_file("thr30measurementAl1159.itx")
    data.iloc[:10] = 0
    ...
    visualize_counts_plot(data, alpha=0.4)
